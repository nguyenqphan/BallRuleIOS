...
#endif
// Native definition for marshalling of: CubeP
struct CubeP_t65458843_marshaled_pinvoke
{
	float ___rotateSpeed_0;
	int32_t ___isRotating_1;
	float ___startTime_2;
	float ___startingY_3;
	float ___newY_4;
	int32_t ___isMovingDown_5;
	int32_t ___isMovingUp_6;
	float ___movementDistance_7;
	float ___floatSpeed_8;
	int32_t ___isOneRound_9;
};
// Native definition for marshalling of: CubeP
struct CubeP_t65458843_marshaled_com
{
	float ___rotateSpeed_0;
	int32_t ___isRotating_1;
	float ___startTime_2;
