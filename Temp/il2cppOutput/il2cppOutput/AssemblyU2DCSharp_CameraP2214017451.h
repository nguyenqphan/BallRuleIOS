...
#endif
// Native definition for marshalling of: CameraP
struct CameraP_t2214017451_marshaled_pinvoke
{
	Vector3_t3525329789_marshaled_pinvoke ___velocity_0;
	float ___smoothTime_1;
	Vector3_t3525329789_marshaled_pinvoke ___playerPos_2;
	Vector3_t3525329789_marshaled_pinvoke ___playerPosNext_3;
	float ___distanceY_4;
	Vector3_t3525329789_marshaled_pinvoke ___playerStartPos_5;
	float ___distanceToMove_6;
};
// Native definition for marshalling of: CameraP
struct CameraP_t2214017451_marshaled_com
{
	Vector3_t3525329789_marshaled_com ___velocity_0;
	float ___smoothTime_1;
	Vector3_t3525329789_marshaled_com ___playerPos_2;
	Vector3_t3525329789_marshaled_com ___playerPosNext_3;
	float ___distanceY_4;
	Vector3_t3525329789_marshaled_com ___playerStartPos_5;
	float ___distanceToMove_6;
};
