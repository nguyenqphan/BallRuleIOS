...
//				ScoreManager.score += 100;
			...
			{
				GameStateManager.Instance.IsPurchased = true;
				GameStateManager.Instance.Save();
				showPanels.noAdsButton.SetActive(false);
				showPanels.rateButton.SetActive(true);
				showPanels.askButton.SetActive(true);
